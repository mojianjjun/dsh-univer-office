# mojia 重打包（dsh 0.1.7-alpha.2 兼容）

- 基底：npm dsh-univer-office@0.2.14 的发布内容（非 git fork，无构建链）
- 补丁：为槽位注册补 options.id，满足 dsh 0.1.7-alpha.2 前端对多注册者列表槽的强制要求
- 上游适配 0.1.7 后可直接换回官方源
